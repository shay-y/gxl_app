                           ...
                           # hidden(
                              withTags(
                                div(id = "results_sec",
                                    ...
                                    label(" Confidence Intervals Plot:"),
                                    hidden(div(id="ci_plot_h",plotOutput("ci_plot",width = "70%"), align = "center")),
...
#                                     actionButton(inputId = "dl_button", label = "Download", icon = icon("download"),
